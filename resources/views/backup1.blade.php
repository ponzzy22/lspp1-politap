...
<head>
    ...
    <link rel="stylesheet" href="public/assets3/css/aos.css">
...
<body class="sidebar-icon-only">
                ...
                <div class="navbar-menu-wrapper d-flex flex-grow">
                    ...
                    Projects
                            ...
                            <div class="dropdown-menu navbar-dropdown" aria-labelledby="projects-dropdown">
                                <a class="dropdown-item" href="#">
                                    <i class="mdi mdi-laptop-mac mr-2 text-primary"></i> Automation
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">
                                    <i class="mdi mdi-database mr-2 text-primary"></i> Big data
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">
                                    <i class="mdi mdi-cellphone-android mr-2 text-primary"></i> Mobile App
                                </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                    ...
                    Employees
                            ...
                            <div class="dropdown-menu navbar-dropdown" aria-labelledby="employees-dropdown">
                                <a class="dropdown-item" href="#">
                                    <i class="mdi mdi-monitor-multiple mr-2 text-primary"></i> Developers
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">
                                    <i class="mdi mdi-scale-balance mr-2 text-primary"></i> Testers
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">
                                    <i class="fa fa-user mr-2 text-primary"></i> Managers
                                </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                    ...
                    Events
                            ...
                            <div class="dropdown-menu navbar-dropdown" aria-labelledby="actions-dropdown">
                                <a class="dropdown-item" href="#">
                                    <i class="mdi mdi-launch mr-2 text-primary"></i> App Launch
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">
                                    <i class="fa fa-user-multiple-outline mr-2 text-primary"></i> Board Meeting
                                </a>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="container-fluid page-body-wrapper">
                    ...
                    <nav class="sidebar sidebar-offcanvas" id="sidebar">
                        <ul class="nav">
                            <li class="nav-item nav-profile">
                                <div class="nav-link">
                                    <div class="profile-image">
                                        <img src="public/assets/images/faces/face5.jpg" alt="image" />
                                    </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="public/assets/index-2.html">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="page-layouts">
                                    <ul class="nav flex-column sub-menu">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="rtl-layout.html">RTL</a>
                                        </li>
                            ...
                            <li class="nav-item d-none d-lg-block">
                                ...
                                <div class="collapse" id="sidebar-layouts">
                                    <ul class="nav flex-column sub-menu">
                                        <li class="nav-item"> <a class="nav-link" href="compact-menu.html">Compact
                                                menu</a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="charts">
                                    <ul class="nav flex-column sub-menu">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="../charts/c3.html">C3
                                                charts</a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="auth">
                                    <ul class="nav flex-column sub-menu">
                                        <li class="nav-item"> <a class="nav-link" href="../samples/login.html">
                                                Login </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/login-2.html">
                                                Login 2 </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/register.html">
                                                Register </a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="general-pages">
                                    <ul class="nav flex-column sub-menu">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="../samples/profile.html">
                                                Profile </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/faq.html"> FAQ
                                            </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/faq-2.html">
                                                FAQ 2 </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/news-grid.html"> News grid </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/timeline.html">
                                                Timeline </a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="apps">
                                    <ul class="nav flex-column sub-menu">
                                        <li class="nav-item"> <a class="nav-link" href="../apps/email.html"> Email
                                            </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../apps/calendar.html">
                                                Calendar </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../apps/todo.html"> Todo
                                            </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../apps/gallery.html">
                                                Gallery </a></li>
                                    </ul>`
                                </div>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="e-commerce">
                                    <ul class="nav flex-column sub-menu">
                                        <li class="nav-item"> <a class="nav-link" href="../samples/invoice.html">
                                                Invoice </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/pricing-table.html"> Pricing Table </a></li>
                                        <li class="nav-item"> <a class="nav-link" href="../samples/orders.html">
                                                Orders </a></li>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <----------------------CAROUSEL----------------------> --}}
                            <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('public/assets/images/carousel/banner_2.jpg') }}" alt="First slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5>Heading</h5>
                                            <p data-aos="fade-up" data-aos-delay="200">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('public/assets/images/carousel/banner_2.jpg') }}" alt="First slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h5 data-aos="fade-up" data-aos-delay="200">Heading</h5>
                                            <p data-aos="fade-up" data-aos-delay="200">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                                        </div>
                                    </div>
                                    {{-- @endforeach --}}
                                    <div class="carousel-item active">
                                        ...
                                        <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <h5 data-aos="fade-up" data-aos-delay="200">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <-----------X-----------CAROUSEL------------X----------> --}}
                                <div class="content-wrapper">
                                    ...
                                    <----------------------CAROUSEL 2----------------------> --}}
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="owl-carousel owl-theme loop owl-loaded owl-drag" style="">
                                                        <div class="owl-stage-outer">
                                                            <div class="owl-stage" style="transition: all 0.25s ease 0s; width: 2065px; transform: translate3d(-481.795px, 0px, 0px);">
                                                                <div class="owl-item cloned" style="width: 127.656px; margin-right: 10px;">
                                                                    <div class="item"><img src="{{ asset('public/assets/images/carousel/banner_2.jpg') }}" alt="image">
                                                                    </div>
                                                                </div>
                                                                <div class="owl-item cloned" style="width: 127.656px; margin-right: 10px;">
                                                                    <div class="item"><img src="{{ asset('public/assets/images/carousel/banner_2.jpg') }}" alt="image">
                                        ...
                                        <-----------X-----------CAROUSEL 2------------X----------> --}}
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-body" style="background-image: url('{{ asset('public/assets/images/carousel/Background-image.png') }}')" style="background-size: cover" style="background-repeat: no-repeat">
                                                        <h4 class="card-title">Custom pills</h4>
                                                        <p class="card-description">Add class <code>.nav-pills-custom</code> and
                                                            <code>.tab-content-custom-pill</code> to <code>.nav-pills</code> and
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-10 mx-auto">
                                                                <ul class="nav nav-pills nav-pills-custom" id="pills-tab-custom" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active show" id="pills-home-tab-custom" data-toggle="pill" href="#pills-health" role="tab" aria-controls="pills-home" aria-selected="true">
                                                            Health
                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                            ...
                                                            Energy
                                                                ...
                                                                <div class="tab-content tab-content-custom-pill" id="pills-tabContent-custom">
                                                                    <div class="tab-pane fade active show" id="pills-health" role="tabpanel" aria-labelledby="pills-home-tab-custom">
                                                                        ...
                                                                        <p>
                                                                            I'm not the monster he wants me to be. So I'm neither man nor beast. I'm something new entirely. With my own set of rules. I'm Dexter. Boo. Only you could make those words cute. I'm thinking two circus clowns dancing. You?
                                                                        </p>
                                                                        <p>
                                                                            Under normal circumstances, I'd take that as a compliment. Tell him time is of the essence. I'm really more an apartment person. Finding a needle in a haystack isn't hard when every straw is computerized.
                                                                        </p>
                                                                    </div>
                                                                    <div class="tab-pane fade" id="pills-career" role="tabpanel" aria-labelledby="pills-profile-tab-custom">
                                                                        <div class="media">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <p>I'm thinking two circus clowns dancing. You? Finding a needle in a haystack isn't hard when every straw is computerized. Tell him time is of the essence. Somehow, I doubt
                                                                    ...
                                                                    <div class="tab-pane fade" id="pills-vibes" role="tabpanel" aria-labelledby="pills-vibes-tab-custom">
                                                                        <div class="media">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <p>
                                                                                    This man is a knight in shining armor. I feel like a jigsaw puzzle missing a piece. And I'm not even sure what the picture should be. Somehow, I doubt that. You have a good heart, Dexter. Keep your mind limber.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="tab-pane fade" id="pills-energy" role="tabpanel" aria-labelledby="pills-energy-tab-custom">
                                                                        <div class="media">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <p>
                                                                                    Finding a needle in a haystack isn't hard when every straw is computerized. You're a killer. I catch killers. I will not kill my sister. I will not kill my sister. I will not kill my sister. Rorschach would say you have a hard time relating to others.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class="col-12 grid-margin stretch-card d-none d-md-flex">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-description">Add class <code>.nav-tabs-vertical-custom</code> to
                                                            <code>.nav</code> and <code>.tab-content-vertical-custom</code> to <code>.tab-content</code>
                                                        </p>
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <ul class="nav nav-tabs nav-tabs-vertical-custom" role="tablist">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active show" id="home-tab-custom" data-toggle="tab" href="#home-3" role="tab" aria-controls="home-3" aria-selected="true">
                                                            ...
                                                            <div class="col-9 col-lg-6">
                                                                <div class="tab-content tab-content-vertical tab-content-vertical-custom">
                                                                    <div class="tab-pane fade active show" id="home-3" role="tabpanel" aria-labelledby="home-tab-custom">
                                                                        ...
                                                                        <h3 class="font-weight-normal">How To Write Better Advertising Copy
                                                                        </h3>
                                                                        ...
                                                                        <p class="mt-4">
                                                                            The key to victory is discipline, and that means a well made bed. You will practice until you can make your bed in your sleep. You don't know how to do any of those. Then throw her in the laundry room, which will hereafter be referred to as "the brig".
                                                                        </p>
                                                                    </div>
                                                                    <div class="tab-pane fade" id="profile-3" role="tabpanel" aria-labelledby="profile-tab-custom">
                                                                        <div class="media">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <p>
                                                                                    And until then, I can never die? I'm a thing. Fry, you can't just sit here in the dark listening to classical music. Is today's hectic lifestyle making you tense and impatient? Is today's hectic lifestyle making you tense and impatient?
                                                                                </p>
                                                                                <p>
                                                                                    Robot 1-X, save my friends! And Zoidberg! Aww, it's true. I've been hiding it for so long. Fry, we have a crate to deliver. Yes! In your face, Gandhi! Interesting. No, wait, the other thing: tedious.
                                                                                </p>
                                                                                <p>
                                                                                    Five hours? Aw, man! Couldn't you just get me the death penalty? Yes! In your face, Gandhi! We're rescuing ya. Yeah, I do that with my stupidness. With gusto.
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="tab-pane fade" id="contact-3" role="tabpanel" aria-labelledby="contact-tab-custom">
                                                                        <div class="media">
                                                                            <div class="media-body">
                                                                                <h5 class="mt-0 mb-1">You've swallowed a planet!
                                                                                </h5>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="owl-carousel owl-theme lazy-load owl-loaded owl-drag" style="">
                                                        {{-- @foreach ($image as $asu) --}} {{--
                                                        <div><img src="{{ asset('public/assets/images/carousel/Background-image.png') }}" alt=""></div> --}} {{-- @endforeach --}}
                                                    </div>
                                                    <a class="carousel-control-prev" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                        <span class="sr-only">Previous</span>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-9 col-md-6 col-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mb-4">
                                                                <div class="text-small float-right font-weight-bold text-muted">2,100
                                                                </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <div class="text-small float-right font-weight-bold text-muted">1,880
                                                                </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <div class="text-small float-right font-weight-bold text-muted">1,521
                                                                </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <div class="text-small float-right font-weight-bold text-muted">884
                                                                </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <div class="text-small float-right font-weight-bold text-muted">473
                                                                </div>
                                                            ...
                                                            <div class="mb-4">
                                                                <div class="text-small float-right font-weight-bold text-muted">418
                                                                </div>
                                                    ...
                                                    <div class="card mt-sm-5 mt-md-0">
                                                        ...
                                                        <div class="card-body">
                                                            <div id="visitorMap" style="position: relative; overflow: hidden; background-color: rgb(255, 255, 255);">
                                                                <svg width="454.5" height="210">
                                                    <g
                                                        transform="scale(0.38181818181818183) translate(120.1785714285714, 0)">
                                                        <path
                                                            ...
                                                            original="#ddd" id="jqvmap1_id" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_pg" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_mx" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ee" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_dz" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ma" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_mr" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ci" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ml" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_bf" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ng" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_tn" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ly" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_eg" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_td" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sd" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_et" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_so" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ye" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_cf" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_st" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_gq" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ga" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_cg" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ao" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ug" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ke" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_tz" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_zm" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_mw" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_mz" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_zw" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_na" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_bw" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            d="M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z"
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sz" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_gl" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_au" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sb" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_vu" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            d="M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z"
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_fj" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ph" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_cn" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            d="M787.46,248.31l-3.54,2.7l-0.19,5.2l3.06,3.56l0.76-0.67L787.46,248.31L787.46,248.31z"
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_tw" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_jp" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ru" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_mg" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_km" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sc" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_mv" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_cv" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ht" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_fk" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_is" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_no" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_lk" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_cu" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_bs" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            d="M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z"
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_jm" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ec" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ca" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_gt" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_pa" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_co" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ve" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_gy" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_pe" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_bo" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_py" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            d="M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z"
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_uy" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ar" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_cl" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_kp" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_kr" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_kz" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_tm" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_uz" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_tj" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_kg" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_af" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_pk" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_th" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_kh" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_la" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_az" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ir" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_tr" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sa" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sy" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_iq" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_gb" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ie" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_se" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_lt" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_by" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_pl" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_it" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_fr" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_de" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_dk" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_sk" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_at" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_ro" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_rs" class="jqvmap-region">
                                                        </path>
                                                        <path
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#f2f2f2" stroke-width="1" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-opacity="0.8" fill="#ddd"
                                                            original="#ddd" id="jqvmap1_gr" class="jqvmap-region">
                                                        </path>
                                                    </g>
                                                </svg>
                                                                <div class="jqvmap-zoomin">+</div>
                                                                <div class="jqvmap-zoomout">−</div>
                                                                <div id="jqvmap1_id_pin" for="id" class="jqvmap-pin" style="position: absolute; left: 340.165px; top: 122.243px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_my_pin" for="my" class="jqvmap-pin" style="position: absolute; left: 330.54px; top: 114.268px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_th_pin" for="th" class="jqvmap-pin" style="position: absolute; left: 320.257px; top: 102.774px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_sy_pin" for="sy" class="jqvmap-pin" style="position: absolute; left: 251.524px; top: 79.0761px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_eg_pin" for="eg" class="jqvmap-pin" style="position: absolute; left: 244.44px; top: 88.7056px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_ae_pin" for="ae" class="jqvmap-pin" style="position: absolute; left: 269.113px; top: 91.0767px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_nz_pin" for="nz" class="jqvmap-pin" style="position: absolute; left: 382.788px; top: 184.164px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_tl_pin" for="tl" class="jqvmap-pin" style="position: absolute; left: 347.464px; top: 132.008px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_ng_pin" for="ng" class="jqvmap-pin" style="position: absolute; left: 221.933px; top: 109.423px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_si_pin" for="si" class="jqvmap-pin" style="position: absolute; left: 227.21px; top: 64.6415px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_pa_pin" for="pa" class="jqvmap-pin" style="position: absolute; left: 126.758px; top: 109.402px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_au_pin" for="au" class="jqvmap-pin" style="position: absolute; left: 350.415px; top: 160.136px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_ca_pin" for="ca" class="jqvmap-pin" style="position: absolute; left: 129.741px; top: 31.9235px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                                <div id="jqvmap1_tr_pin" for="tr" class="jqvmap-pin" style="position: absolute; left: 247.483px; top: 73.912px;">
                                                                    <div class="jqvmap-circle"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card">
                                                        <article class="article article-style-b">
                                                            <div class="article-header">
                                                                <img src="http://localhost/lspp1-politap/public/uploads/berita/1650210191wp4676582.jpg" alt="" width="289px">
                                                            </div>
                                                            <div class="article-details">
                                                                <div class="article-title">
                                                                    <h2 class="text text-dark"><a href="#">sas</a></h2>
                                                                </div>
                                                                <p>dsfadfsad</p>
                                                                <div class="article article-title">
                                                                    <a href="http://localhost/lspp1-politap/berita/11">
                                                                        <h6>Read More</h6> <i class="fas fa-chevron-right"></i>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </article>
                                ...
                                <footer class="footer">
                                    ...
                                    &amp; made
                                    with
                                    <i class="far fa-heart text-danger"></i><a href="https://politap.ac.id/"
    ...
    {{--
    <----------------------CAROUSEL JS----------------------> --}}
        <script src="public/assets3/js/Jquery3.4.1.min.js"></script>
        <script src="public/assets3/js/owl.carousel.min.js"></script>
        <script src="public/assets3/js/aos.js"></script>
        <script src="public/assets3/js/main.js"></script>
        {{--
        <-----------X-----------CAROUSEL JS------------X----------> --}}
