                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" name="kode_skema" class="form-control" placeholder="Kode Skema"/>
                            @error('kode_skema')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                            @enderror
                            </div>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="text-right">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton3">
                                    <a href="{{ route('skema.edit', $asu->id) }}"><button type="submit" class="btn btn-inverse-warning btn-sm btn-block"><i class="fa fa-edit "></i>  Edit Skema</button></a>
                                    <a href="{{ route('skema.detail', $asu->id) }}"><button type="submit" class="btn btn-inverse-info btn-sm btn-block"><i class="fa fa-eye "></i>  Lihat Detail Skema</button></a>
                                    <a href="{{ route('skema.show', $asu->id) }}"><button type="submit" class="btn btn-inverse-primary btn-sm btn-block"><i class="fa fa-list "></i>  List Unit Kompetensi</button></a>
                                    <form action="{{ route('skema.destroy', $asu->id) }}" method="POST" onsubmit="return confirm('Apa anda yakin akan menghapus Data ini (Yakinkan lah aku)')">
                                        @csrf
                                        @method('delete')
                            ...
                            <td><label class="badge badge-light">{{ $asu->status->status }}</label></td>
                        </tr>
                    @endforeach
                    </tbody>
                    </table>
