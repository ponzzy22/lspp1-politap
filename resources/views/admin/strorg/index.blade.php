...
<div class="page-header">
    <h3>
        <i class="fas fa-cogs"></i> Edit Gambar Struktur Organisasi
    </h3>
     <!-- /////////////////////////////////// -->
        <!-- BREADCRUMB -->
     <!-- /////////////////////////////////// -->
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('strorg.update', $asu->id) }}"  class="forms-sample" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
