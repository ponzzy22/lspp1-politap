    ...
    <div class="card-body">
      <form action="{{ route('f_profil.update', $profil->id) }}" enctype="multipart/form-data" method="POST" class="forms-sample">        
        ...
        <div class="form-group">
          ...
          <textarea maxlength="800" class="form-control" id="exampleTextarea1" rows="4" name="profil">{{ $profil->profil }}</textarea>
        </div>
        <div class="form-group">
            <label for="exampleTextarea1">Visi LSP P1-POLITAP</label>
            <textarea maxlength="800" class="form-control" id="exampleTextarea1" rows="4" name="visi">{{ $profil->visi }}</textarea>
        </div>
        <div class="form-group">
            <label for="exampleTextarea1">Misi LSP P1-POLITAP</label>
            <textarea maxlength="800" class="form-control" id="exampleTextarea1" rows="4" name="misi">{{ $profil->misi }}</textarea>
        </div>
        <div class="form-group">
            <label for="exampleTextarea1">Motto LSP P1-POLITAP</label>
            <textarea maxlength="800" class="form-control" id="exampleTextarea1" rows="4" name="motto">{{ $profil->motto }}</textarea>
        </div>
        ...
        <a href="{{ route('f_profil.edit', $profil->id) }}"><button  type="button" class="btn btn-danger btn-icon-text">
