            ...
            <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
              ...
              <thead>
                <tr class="bg-warning text-white" role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 975.75px;">TUK</th>
                  <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Ship to: activate to sort column ascending" style="width: 657.5469px;">Keterangan</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="text-right">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton3">
                        <form action="{{ route('tuk.destroy', $asu->id) }}" method="POST" onsubmit="return confirm('Apa anda yakin akan menghapus Data ini (Yakinkan lah aku)')">
                            @csrf
                            @method('delete')
                            <a href=""><button type="submit" class="btn btn-inverse-danger btn-sm btn-block"><i class="fa fa-trash "></i>  Hapus TUK</button></a>
                        </form>
                    </div>
                </td>
                  <td>{{ $asu->tuk }}</td>
