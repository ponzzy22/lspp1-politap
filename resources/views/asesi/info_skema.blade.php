...
<div class="card">
    <div class="card-body">
        <div class="card-title">
            <h6 class="font-weight-bold"><i class="fab fa-pagelines"></i> Daftar Skema</h6>
        </div>
        <div class="row">
        <div class="col-12">
                ...
                <div class="row">
                    ...
                    @foreach ($skema as $hasil => $asu)
                        <tr role="row" class="odd">
                            ...
                            <td class="text-right">
                                <a href="{{ route('info_skema.show', Crypt::encryptString($asu->id)) }}"><button type="submit" class="btn btn-inverse-dark btn-sm btn-block font-weight-bold"><i class="fa fa-eye "></i>  Lihat Detail Skema</button></a>
                            </td>
