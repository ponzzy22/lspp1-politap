...
<div class="page-header">
  <h4>
      <i class="fas fa-circle"></i>  Langkah Ke-3 <i class="fas fa-angle-double-right"></i> Mengisi Assesmen Mandiri / Formulir APL-02
  </h4>
</div><br>
...
<div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <button style="align-items: center" type="button" class="btn btn-warning btn-sm" data-toggle="popover" 
            title="Perhatian!!" 
            data-content="Wajib mengisi semua Assesmen >> Format file berupa 'PDF/PNG/JPEG' >> Upload file kemudian Klik centang biru(K) / jika tidak ada file klik centang merah(BK) >> Jika upload berhasil akan muncul di 'Status Asesmen'di tabel sebelah kanan.." data-original-title="Popover title" aria-describedby="popover635060">
                ...
                <tr>
                  <td>{{ $loop->iteration }}</td>
                    ...
                    <form action="{{ route('xnxx.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <input type="hidden" name="kode" value="{{ $loop->iteration }}{{ Auth::user()->id }}">
                  ...
                  <form action="{{ route('xnxx.store2') }}" method="post">
                      ...
                      <td><button class="btn btn-inverse-danger btn-sm" type="submit"><i class="fa  fa-times"></i></button></td>
                  </form>
                </tr>
            </tbody>
            @endforeach
          ...
          <div class="table-responsive">            
            <table class="table table-hover">
              ...
              <tbody>
                  <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td><div class="badge badge-light">{{ $data->status }}</div></td>
    ...
    <div class="col-lg-8 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <button style="align-items: center" type="button" class="btn btn-warning btn-sm" data-toggle="popover" 
            title="" 
            data-content="Lengkapi data berikut seperti cara diatas >> Setelahnya klik tombol 'Kirim Data Registrasi'" data-original-title="Popover title" aria-describedby="popover635060">
            ...
            <tbody>
                <tr>
                    ...
                    <form action="{{ route('identitas.store') }}" enctype="multipart/form-data" method="post">
                      ...
                      <td>
                      <button class="btn btn-inverse-info btn-sm" type="submit"><i class="fas fa-check"></i></button></td>
                  </form>
                  {{-- //////// TIDAK ADA  ////////////// --}}
                  <form action="{{ route('identitas.store2') }}" method="post">
                      ...
                      <td><button class="btn btn-inverse-danger btn-sm" type="submit"><i class="fas fa-times"></i></button></td>
                  </form>
                </tr>
                <tr>
                    <td>2</td>
                ...
                @csrf
                    ...
                    <input type="hidden" name="name" value="Kartu Hasil Semester">
                    <input type="hidden" name="status" value="Tidak Ada">
                <td><button disabled class="btn btn-inverse-danger btn-sm" type="submit"><i class="fas  fa-times"></i></button></td>
                </form>
              </tr>
              <tr>
                <td>6</td>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                      ...
                      <td>{{ $data->name }}</td>
                      <td>
                        <form action="{{ route('identitas.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Apa anda yakin akan menghapus Artikel ini (Yakinkan lah aku)')">
                          @csrf
                          @method('delete')
                          <button class="btn btn-danger btn-sm" type="submit"><i class="fas fa-trash-alt"></i></button>
                        </form>
  ...
  <a href="{{ route('dashasesi.index') }}"><button class="btn btn-success btn-block" onclick="showSwal('success-message')">Kirim Data Registrasi <i class="fas fa-flag-checkered"></i></button></a>
<br><br>
@endsection
