    ...
    <div class="card">
        <div class="card-body">
            ...
            <button style="align-items: center" type="button" class="btn btn-warning btn-sm" data-toggle="popover"
                title="Perhatian!!"
                data-content="Peserta wajib mengisi semua data Informasi Pribadi dibawah ini dengan benar >> Setelah lengkap klik tombol 'Daftar' >> Setelah itu klik tombol 'Selanjutnya'.. "
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" maxlength="25" class="form-control" name="nim"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" maxlength="6" class="form-control" name="kode_post"
            ...
            <a href="{{ route('xnxx.show', $skema->id) }} }}"><button class="btn btn-success btn-block"> Selanjutnya <i
