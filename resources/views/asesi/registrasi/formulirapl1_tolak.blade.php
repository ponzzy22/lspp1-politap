        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>2. Setelah Upload berhasil keterangan Statusnya menjadi <span style="color: brown">Ada</span>. </p>
                    <p>3. Pastikan semua data pada Upload Dokumen Pendukung harus terisi. </p>
                    <p>4. Lengkapi dan isi data profil anda. </p>
                    <p>5. Klik tombol <span style="color: brown"> Simpan</span> data pada paling bawah halaman </p>
                    <p>5. Kemudian Klik Tombol <span style="color: brown"> Simpan</span> data pada paling bawah halaman </p>
                </div>
