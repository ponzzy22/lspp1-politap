...
=======
            <i class="fas fa-id-card"></i>  Edit Data Pribadi
...
=======
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('formulirapl3.update') }}" method="POST" enctype="multipart/form-data"
                class="form-sample">
                @csrf
                @method('put')
...
=======
                ...
                <a href=""><button class="btn btn-info btn-block"><i class="fas fa-save"></i> Selanjutnya</button></a>
            </form>
        </div>
>>>>>>> b6059d523f85d340682094e54c8f33088f088db9
    </div>
