...
@section('isi')
    ...
    <div class="page-header">
        <h3 class="font-weight-normal text-primary" data-aos="fade-left" data-aos-delay="300"><i class="fas fa-info-circle"></i>
            Berita </h3>
    ...
    <div class="row">
        <div class="col-lg-9 col-md-6 col-12">
            @foreach ($berita as $asu)
                <div data-aos="fade-right" data-aos-delay="300" class="card-body">
                    <div class="media">
